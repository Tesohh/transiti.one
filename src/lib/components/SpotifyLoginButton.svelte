<script lang="ts">
  export let authWithSpotify: () => void
</script>

<button
  on:click={authWithSpotify}
  class="bg-tbg p-2 text-white border-solid border-4 border-black"
>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    height="168"
    width="168"
    style="width:26px;height:26px;margin-right:10px;vertical-align:-6px"
    class="inline-block"
